            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                     ...
                     <li>
                        <a  href="regSample.php"><i class="fa fa-desktop fa-3x"></i> Sign Up</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
			...
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    ...
                    <div class="col-sm-4 col-sm-8 col-xs-8">           
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text"></p>
                    <p class="text-muted"><a href="regSample.php">REGISTER/SIGN UP</a></p>
                </div>
             </div>
		     </div>
			</div>
